...
3. Update the changelog in `README.md` with user-facing changes, fixes, and any migration notes.
...
2. Create and push a Git tag that exactly matches `manifest.json`'s version—without a `v` prefix.
